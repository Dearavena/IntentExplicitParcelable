    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME,"Dea Ravena");
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_AGE,17);
                startActivity(moveWithDataIntent);
                break;
            case R.id.btn_move_activity_object:
                Person mPerson = new Person();
                mPerson.setName("Dea Ravena");
                mPerson.setAge(17);
                mPerson.setEmail("dearavena123@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "089622648692";
